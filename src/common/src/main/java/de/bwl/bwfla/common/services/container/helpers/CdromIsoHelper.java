...
{	
	...
	private Container createContainerAndInject(List<File> files) 
	{		
		File cdromFile = null;
		File pathnames = null;
		...
		try
		{
			...
			runner.addArguments("-o", cdromFile.getAbsolutePath());
	...
	{
		Container buf = this.createContainerAndInject(files);
