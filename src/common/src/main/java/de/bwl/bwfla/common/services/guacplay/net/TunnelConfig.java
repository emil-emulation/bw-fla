...
public final class TunnelConfig
{
	...
	public static TunnelConfig fromValue(String data) throws JAXBException
	{
    	JAXBContext jc = JAXBContext.newInstance(TunnelConfig.class);
    	Unmarshaller unmarshaller = jc.createUnmarshaller();
    	StreamSource source = new StreamSource(new StringReader(data));
    	return (TunnelConfig) unmarshaller.unmarshal(source);
    }
