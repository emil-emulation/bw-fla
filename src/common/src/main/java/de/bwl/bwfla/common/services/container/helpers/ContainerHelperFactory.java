...
{	
	...
	{	
		if(dev.equalsIgnoreCase(Drive.DriveType.DISK.toString()))
		...
		if(dev.equalsIgnoreCase(Drive.DriveType.FLOPPY.toString()))
			return new FloppyFat12Helper();
		
		if(dev.equalsIgnoreCase(Drive.DriveType.CDROM.toString()))
			return new CdromIsoHelper();
		
		if(dev.equalsIgnoreCase(Drive.DriveType.CDROM_IMG.toString()) || dev.equalsIgnoreCase(Drive.DriveType.DISK_IMG.toString()) || dev.equalsIgnoreCase(Drive.DriveType.FLOPPY_IMG.toString()))
