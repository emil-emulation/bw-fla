...
public class Checksums {
     ...
     */
    public static byte[] sha1 (InputStream in) throws IOException, DigestException {
        try {
     ...
     */
    public static byte[] sha1 (String in) throws DigestException {
        try {
            return digest ("SHA-1", in);
        } catch (NoSuchAlgorithmException e) {
            throw new DigestException("Unknown algorithm: SHA-1");
     ...
     * @throws DigestException if the JVM doesn't know the {@code SHA-1} algorithm
     */
    public static byte[] sha1 (File in) throws IOException, DigestException {
        try {
            return digest ("SHA-1", in);
        } catch (NoSuchAlgorithmException e) {
            throw new DigestException("Unknown algorithm: SHA-1");
     ...
     */
    public static byte[] md5 (InputStream in) throws IOException, DigestException {
        try {
     ...
     * @throws DigestException if the JVM doesn't know the {@code MD5} algorithm
     */
    public static byte[] md5 (String in) throws DigestException {
        try {
            return digest ("MD5", in);
        } catch (NoSuchAlgorithmException e) {
            throw new DigestException("Unknown algorithm: MD5");
     ...
     * @throws DigestException if the JVM doesn't know the {@code MD5} algorithm
     */
    public static byte[] md5 (File in) throws IOException, DigestException {
        try {
            return digest ("MD5", in);
        } catch (NoSuchAlgorithmException e) {
            throw new DigestException("Unknown algorithm: MD5");
