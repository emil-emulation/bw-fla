...
@ManagedBean
@ViewScoped
public class WF_PLAY_3 extends BwflaFormBean implements Serializable
{
	private static final long serialVersionUID = 3177089307800599617L;
	...
	{
		return WF_PLAY_Data.getStartPageUrl();
	}
}