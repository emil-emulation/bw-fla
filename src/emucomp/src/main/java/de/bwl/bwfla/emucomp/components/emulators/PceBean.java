...
public abstract class PceBean extends EmulatorBean
{
	...
	private final String emuExecPath;
	
	
	public PceBean(String emuExecPath)
	{
		super();

		this.emuExecPath = emuExecPath;
	...
	public void prepareEmulatorRunner() throws BWFLAException
	{
		...
		// Use SDL devices
		runner.addArguments("--terminal" , "sdl");
		runner.addArgument("--no-monitor");
		runner.addArgument("--verbose");
		runner.addArgument("--run");
	...
	public void finishRuntimeConfiguration() throws BWFLAException
	{
		...
		try {
			...
			final File configFile = new File(tempDir, "pce.cfg");
			...
			runner.addArguments("--config", configFile.getAbsolutePath());
		}
